...
class ProductManager(models.Manager):
    ...
    def filtrar(self, **filters):
        """ Filters representa al Dict que se envia por GET mediante a URL y se acceden a sus claves para ver los valores """
        
        if not filters['date_start']:
            filters['date_start'] = timezone.now().date() - timedelta(1080)
